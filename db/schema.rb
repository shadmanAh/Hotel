...
ActiveRecord::Schema[7.0].define(version: 2022_09_13_131343) do
  ...
  create_table "enrollments", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "slug"
    t.index ["hostel_id"], name: "index_enrollments_on_hostel_id"
  ...
  create_table "hostels", force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_hostels_on_slug", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "slug"
    t.integer "hostels_count", default: 0, null: false
    t.integer "enrollments_count", default: 0, null: false
  ...
  add_foreign_key "enrollments", "hostels"
